...
python3 upload_to_s3bucket.py -i source-gdas_date-"$curr_datetime"_res-0.25_levels-13_steps-2.nc -o forecast_date-"$curr_datetime"_res-0.25_levels-"$num_pressure_level"_steps-"$forecast_length".nc
