...
prev_datetime=$( date -d "$datetime 6 hour ago" "+%Y%m%d%H" )
...
python3 run_graphcast.py -i source-gdas_date-"$curr_datetime"_res-0.25_levels-13_steps-1.nc -o "$curr_datetime"
